frappe.dom.set_style("/* sfc-style:/home/dev2/projects/v15/apps/library_management/library_management/public/js/books/Books.vue?type=style&index=0 */\n.book-items-card[data-v-3dde91c7] {\n  height: calc(100vh - 150px);\n}\n.book-items-card-body[data-v-3dde91c7] {\n  overflow: auto;\n}\n.book-img[data-v-3dde91c7] {\n  height: 200px;\n  width: auto;\n  object-fit: contain;\n}\n.card-header[data-v-3dde91c7] {\n  background-color: white;\n}\n@media only screen and (max-width: 768px) {\n  .book-items-card[data-v-3dde91c7] {\n    height: 50vh;\n  }\n}\n/*# sourceMappingURL=books.bundle.3AVGIWBC.css.map */\n");
(() => {
...
This will fail in production.`);
  ...
  var Books_default = {
    ...
    setup(__props, { expose: __expose }) {
      ...
      const __returned__ = { get bookstore() {
        return bookstore;
      }, set bookstore(v) {
        bookstore = v;
      }, onMounted, get useBooksStore() {
  ...
  var _withScopeId = (n) => (pushScopeId("data-v-3dde91c7"), n = n(), popScopeId(), n);
  var _hoisted_1 = { class: "container" };
  var _hoisted_2 = { class: "row" };
  var _hoisted_3 = { class: "col-12 col-md-12 col-lg-12" };
  var _hoisted_4 = { class: "card book-items-card" };
  var _hoisted_5 = { class: "card-header" };
  var _hoisted_6 = { class: "container" };
  var _hoisted_7 = { class: "row d-flex justify-content-between align-items-center" };
  var _hoisted_8 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "col-6" }, [
    /* @__PURE__ */ createBaseVNode("h4", { class: "card-title mb-0" }, "Books")
  ], -1));
  var _hoisted_9 = { class: "col-6 p-0" };
  var _hoisted_10 = { class: "input-group search-bar text-muted" };
  var _hoisted_11 = { class: "w-100" };
  var _hoisted_12 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "search-icon" }, [
    /* @__PURE__ */ createBaseVNode("svg", { class: "icon icon-sm" }, [
      /* @__PURE__ */ createBaseVNode("use", { href: "#icon-search" })
    ])
  ], -1));
  var _hoisted_13 = { class: "card-body book-items-card-body" };
  var _hoisted_14 = { class: "container p-0" };
  ...
  var _hoisted_19 = { class: "card-title mt-0 d-sm-inline-flex" };
  var _hoisted_20 = { class: "card-text ml-0 mb-3" };
  var _hoisted_21 = { class: "card-text ml-0 mb-3" };
            ...
            createBaseVNode("div", _hoisted_5, [
              createBaseVNode("div", _hoisted_6, [
                createBaseVNode("div", _hoisted_7, [
                  _hoisted_8,
                  createCommentVNode(' <div v-for="category in bookstore.item_categories" :key="category.name" class="filter-btn">\n                                    <button @click="bookstore.get_items_by_category(category.name)" class="btn btn-sm btn-primary">{{ category.name }}</button>\n                                </div> '),
                  createBaseVNode("div", _hoisted_9, [
                    createBaseVNode("div", _hoisted_10, [
                      createBaseVNode("div", _hoisted_11, [
                        withDirectives(createBaseVNode("input", {
                          onInput: _cache[0] || (_cache[0] = ($event) => $setup.bookstore.search_books()),
                          "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $setup.bookstore.search_book = $event),
                          id: "navbar-search",
                          type: "text",
                          class: "form-control pl-5",
                          placeholder: "Search Books"
                        }, null, 544), [
                          [vModelText, $setup.bookstore.search_book]
                        ])
                      ]),
                      _hoisted_12
                    ])
                    ...
                    return openBlock(), createElementBlock("div", {
                      ...
                      createBaseVNode("div", _hoisted_16, [
                        ...
                        createBaseVNode("div", _hoisted_18, [
                          createBaseVNode("h4", _hoisted_19, toDisplayString(item.title), 1),
                          createBaseVNode("h6", _hoisted_20, "By: " + toDisplayString(item.author), 1),
                          createBaseVNode("h6", _hoisted_21, "subjects: " + toDisplayString(item.subject), 1)
                        ]),
                        createCommentVNode(' <button @click="bookstore.add_item(item)" class="btn btn-primary" type="button">Add</button> ')
                      ])
                    ]);
                  }), 128))
                ])
...
* @license MIT
**/
//# sourceMappingURL=books.bundle.6WOEMB5U.js.map
